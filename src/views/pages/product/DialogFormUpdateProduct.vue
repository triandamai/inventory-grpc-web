...
import { ProductResponse, UpdateProductRequest } from "@/store/product/type";
...
const props = defineProps({
  ...
  body: {
    type: Object as PropType<ProductResponse | null>,
    default: null
  }
})
...
const form = ref<UpdateProductRequest>({
  productId: "",
  productName: "",
  productDescription: "",
  productImage: "",
...
watch(() => props.body, (newValue) => {
  if (newValue) {
    const category = () => {
      if (Array.isArray(newValue.category)) {
        return newValue.category.map((v) => v.categoryId)
      }
      return []
    }
    form.value = {
      ...
      productDescription: newValue.productDescription,
      productImage: newValue.productImage,
      productInboundPrice: newValue.productInboundPrice,
      productOutboundPrice: newValue.productOutboundPrice,
      productStock: newValue.productStock,
      productUnit: newValue.productUnit,
      category: category(),
    }
  }
})
